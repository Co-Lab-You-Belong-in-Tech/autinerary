      ...
      <svg className="car" width="102px" height="40px" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="gradient" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#2998ff" />
            <stop offset="100%" stopColor="#ff4bfd" />
          </linearGradient>
        </defs>
        <g transform="translate(2 1)" stroke="url(#gradient)" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
          ...
          <path className="car__line car__line--top" stroke="#2998ff" d="M22.5 16.5H2.475" strokeWidth="3"/>
          <path className="car__line car__line--middle" stroke="#2998ff" d="M20.5 23.5H.4755" strokeWidth="3"/>
          <path className="car__line car__line--bottom" stroke="#2998ff" d="M25.5 9.5h-19" strokeWidth="3"/>
        </g>
      </svg>
    </div>
  )
